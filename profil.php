...
if ($user->getNbrTweet($_SESSION['id']) == false)
    $fetchTweet = 0;
else {
    $fetchTweet = $user->getNbrTweet($_SESSION['id']);
}

$InfoCurrentUser = $user->getInfoMembre($_SESSION['id']);
...
<body>
    ...
    <section class="profile">
        <header class="header">
            <div class="details">
                <img src="https://pbs.twimg.com/profile_images/983370939122495489/hPTuWnVP_400x400.jpg" alt="John Doe" class="profile-pic">
                <h1 class="heading"><?php echo $_SESSION['pseudo']; ?></h1>
                <div class="location">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12,11.5A2.5,2.5 0 0,1 9.5,9A2.5,2.5 0 0,1 12,6.5A2.5,2.5 0 0,1 14.5,9A2.5,2.5 0 0,1 12,11.5M12,2A7,7 0 0,0 5,9C5,14.25 12,22 12,22C12,22 19,14.25 19,9A7,7 0 0,0 12 ,2Z"></path>
                    </svg>
                    <p><?php echo $InfoCurrentUser['pays']; ?></p>
                </div>
                <div class="stats">
                    <div class="col-4">
                        <h4><?php $user->getFollowing($_SESSION['id']); ?></h4>
                        <p>Followings</p>
                    </div>
                    <div class="col-4">
                        <h4><?php $user->getFollower($_SESSION['id']); ?></h4>
                        <p>Followers</p>
                    </div>
                    <div class="col-4">
